...
<section <?= $show_video ? "" : 'style="background-image:url(' . $background_image['sizes']['heading-banner'] . ')"' ?> class="fdm-header-banner" data-num-ctas="<?= $call_to_actions ? count( $call_to_actions ) : 0 ?>">
